(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    /***/
    function srcAppServicesNoticiasServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "NoticiasService", function () {
      ...
      var NoticiasService = /*#__PURE__*/function () {
        function NoticiasService(http) {
          _classCallCheck(this, NoticiasService);

          this.http = http;
          this.KEY = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiKey;
        ...
        _createClass(NoticiasService, [{
          key: "query",
          value: function query(_query) {
            //this.http2.setHeader("*", "x-Api-key",this.KEY);
            return this.http.get(this.URL + _query, {
          ...
          value: function getTopHeadlines() {
            this.headlinesPage++;
            return this.query("/top-headlines?country=us&page=".concat(this.headlinesPage));
          }
        }, {
          key: "getTopHeadLinesCategory",
          value: function getTopHeadLinesCategory(category) {
            ...
            return this.query("/top-headlines?country=us&category=".concat(category, "&page=").concat(this.categoryPage));
          }
        }]);
      ...
      NoticiasService.ctorParameters = function () {
        return [{
          type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]
        }];
      };

      NoticiasService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
        providedIn: "root"
      })], NoticiasService);
      /***/
    }
